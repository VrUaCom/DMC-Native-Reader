// Native Reader C++23 port of dmc-rengine-cpp src/formats/mod/world_transform.cpp.
// It replaces the pinned submodule's copy inside dmc_rengine_reader_core (see
// CMakeLists.txt) because the pin predates the Euler-order correction
// (dmc-rengine-cpp b403108, docs/research/dmc3-euler-order-correction-2026-09-23.md).
// Drop this file when the pin moves past that commit.
